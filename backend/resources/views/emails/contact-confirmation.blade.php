...
<body style="font-family: Arial, sans-serif; color: #1E293B; background: #F8FAFC; padding: 24px;">
    <div style="max-width: 560px; margin: 0 auto; background: #FFFFFF; border-radius: 12px; overflow: hidden; border: 1px solid #E2E8F0;">
        ...
        <div style="padding: 28px;">
            ...
            <p>Thanks for reaching out to Abeekey. We've received your message and a member of our team will get back to you shortly.</p>

            <p style="color: #64748B; font-size: 13px; margin-top: 24px; border-top: 1px solid #E2E8F0; padding-top: 16px;">
                Your message:<br>
                @if($contactMessage->subject)
                    <strong>{{ $contactMessage->subject }}</strong><br>
                @endif
