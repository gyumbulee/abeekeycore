...
const ADMIN_NAV: SidebarNavGroup[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { href: '/admin/hosting-plans', label: 'Hosting Plans', icon: Server },
      { href: '/admin/hosting-orders', label: 'Hosting Orders', icon: Server },
...
const PERMISSION_BY_HREF: Record<string, string> = {
  ...
  '/admin/hosting-plans': 'hosting',
  '/admin/hosting-orders': 'hosting',
